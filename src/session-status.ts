...
//
// Historically `/status` showed only a count ("Claude sessions: 2"). The
// operator asked for a breakdown: one line per connected Claude session with
// who it is, its MCP client, and how long it has been connected.
//
